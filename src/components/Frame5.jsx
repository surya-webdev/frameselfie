  ...
  const downloadImage = async (image) => {
    ...
    frameImg.onload = () => {
      ...
      selfieImg.onload = () => {
        ...
        const frameBorder = frameStyle.border;
        ...
        const centerX = frameBorder + innerSize / 2;
        const centerY = frameBorder + innerSize / 2;

        const x = centerX - scaledWidth / 2 + image.offsetX;
        const y = centerY - scaledHeight / 2 + image.offsetY;
